  ...
  return (
    <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-background via-secondary/20 to-background opacity-70"></div>
        ...
        <div className="absolute top-40 right-60 w-32 h-32 border border-primary/10 rounded-full"></div>
      ...
      <div className="container-custom mt-20 md:mt-24">
        <div className="relative w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] rounded-xl overflow-hidden shadow-2xl animate-fade-in opacity-0" style={{ animationDelay: "0.5s", animationFillMode: "forwards" }}>
          ...
          <div className="absolute top-0 left-0 w-24 h-24 border-l-2 border-t-2 border-white/20 rounded-tl-xl"></div>
          <div className="absolute top-0 right-0 w-24 h-24 border-r-2 border-t-2 border-white/20 rounded-tr-xl"></div>
          <div className="absolute bottom-0 left-0 w-24 h-24 border-l-2 border-b-2 border-white/20 rounded-bl-xl"></div>
          <div className="absolute bottom-0 right-0 w-24 h-24 border-r-2 border-b-2 border-white/20 rounded-br-xl"></div>
          ...
          {/* Floating text badge */}
          <div className="absolute bottom-8 right-8 bg-white/90 backdrop-blur-sm py-3 px-6 rounded-full shadow-lg transform rotate-2">
            <span className="font-display text-lg">New Season 2023</span>
          </div>
        </div>
      </div>
    </section>
